...
export default function Projects() {
  return (
    <div id="projects" className="flex items-center justify-center h-screen p-40 bg-gradient-to-r from-indigo-500 to-purple-500">
      <Carousel>
        {projects.map((item, i) => <div className='p-5 mt-8 transition-all shadow opacity-50 cursor-pointer h-100 hover:bg-white hover:opacity-100 rounded-xl hover:-translate-y-6' key={i}>
