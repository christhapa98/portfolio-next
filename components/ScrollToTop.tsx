...
export function ScrollToTop() {
    ...
    return (
        ...
        <button onClick={handleClick} className={`fixed bottom-20  md:bottom-4 right-4 bg-white-500 text-black border border-gray-500 bg-white rounded-full p-3 shadow-xl transition-opacity duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'
            }`}>
